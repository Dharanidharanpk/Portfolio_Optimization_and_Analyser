...
def team_info():
    ...
    developer1_image_url = "https://drive.usercontent.google.com/download?id=1dc4WoB-u94cNCfovD3kucA14NbgjCsE3&export=view&authuser=0"  # Replace with your actual Google Drive file ID
    with col1:
